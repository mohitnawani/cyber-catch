  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 p-4 mx-auto backdrop-blur-sm">
      <div className="relative w-full max-w-90 rounded-sm bg-white p-7 shadow-[0_18px_45px_rgba(15,41,64,0.2)]">
        ...
        <label className="mt-5 block text-[10px] font-bold text-navy">
        ...
        <label className="mt-4 block text-[10px] font-bold text-navy">
          ...
          <div className="relative mt-1">
            <select
              value={parentName}
              disabled
              className="h-8 w-full appearance-none rounded border border-[#e5e6ef] bg-[#fafaff] px-2 pr-7 text-[10px] text-navy outline-none"
            >
