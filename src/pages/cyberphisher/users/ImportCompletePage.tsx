...
<div
  className="
    mt-6 flex min-h-[96px] flex-col items-center justify-center rounded-md
    border-2 border-transparent
    [border-image:repeating-linear-gradient(90deg,#87e6b2_0_8px,transparent_8px_18px)_1]
    bg-[#ecfff3] px-8 text-center
  "
>
  <Check className="mb-1 text-[#16ad63]" size={20} />

  <h3 className="text-[11px] font-bold text-[#19a45b]">
    RECORDS SUCCESSFULLY IMPORTED!
  </h3>

  <p className="mt-1 max-w-[630px] text-[10px] leading-4 text-[#2cac69]">
