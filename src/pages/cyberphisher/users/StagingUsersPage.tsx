...
export default function StagingUsersPage({
  ...
  return (
    <section className="max-w-[920px] pt-1 mx-auto">
      ...
      <p className="mt-2 text-sm leading-6 text-navy/80">
      ...
      <div className="mt-6 rounded-md border border-dashed border-[#f3c36e] bg-[#fff4dc] px-6 py-5 text-center">
      ...
      <div className="mt-5 overflow-x-auto">
        <div className="min-w-[690px]">
          <div className="grid grid-cols-[34px_1.2fr_1.7fr_1.25fr_.65fr] px-3 pb-2 text-[11px] font-semibold text-[#8586a3]">
            <span></span>
            <span>User</span>
            <span>Email</span>
            ...
            {members.map((member) => {
              ...
              return (
                <button
                  ...
                  key={member.id}
                  className="grid w-full grid-cols-[34px_1.2fr_1.7fr_1.25fr_.65fr] items-center rounded-xl bg-white px-3 py-3 text-left text-[11px] text-navy/80 shadow-[0_4px_14px_rgba(15,41,64,0.05)] hover:bg-[#fafaff]"
                >
                  <span
      ...
      <div className="mt-4 flex items-center justify-between text-[10px] text-[#999cb9]">
