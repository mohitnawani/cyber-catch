    ...
    <section className="mx-auto w-full max-w-[920px] pt-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          >
            <ChevronLeft size={12} /> User Groups
          </button>
          <h2 className="mt-0.5 text-[24px] font-bold tracking-[-0.03em] text-black">
            {groupName}
          </h2>
          <p className="mt-0.5 text-xs leading-5 text-navy/75">
      ...
      <div className="mt-5 overflow-x-auto pb-1">
        ...
        <div className="space-y-2">
          {members.length ? (
            ...
            <p className="rounded-xl bg-white p-3 text-center text-xs text-navy/55">
