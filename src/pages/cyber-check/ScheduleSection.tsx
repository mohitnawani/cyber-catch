...
const inputClass =
  'mt-3 rounded-md border border-gray-light bg-white px-3 py-2.5 text-sm font-normal text-navy/65 outline-none focus:border-brand'
...
export default function ScheduleSection() {
  ...
  return (
    <section className="max-w-[680px] py-4 md:py-8 overflow-auto">
      ...
      <div className="mt-6 md:mt-7 max-w-[420px] space-y-5 md:space-y-6">
        ...
        {interval === 'monthly' && (
          <label className={fieldLabelClass}>
            ...
            <p className={`mt-3 font-normal ${helperTextClass}`}>
