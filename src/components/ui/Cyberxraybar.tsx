import { CalendarDays, ClipboardCheck,  ScanSearch } from 'lucide-react'
...
export default function Cyberxraybar() {
  return (
    <aside className="-my-3 w-[178px] shrink-0 bg-white-pure px-4 py-12 shadow-[2px_0_12px_rgba(15,41,64,0.04)]">
      ...
      <h1 className="mt-3 text-[15px] font-bold leading-[1.05] text-navy">Welcome to<br />Cyber X-Ray!</h1>
